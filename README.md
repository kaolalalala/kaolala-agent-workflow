...
大家可以随意的去改进，目前虽然很多功能都有了，但是整体感觉还不是很深，不过很多基础功能已经具备了
如果觉得不错，或者要拿去用的话，希望大家能点个⭐，这对正在找实习的我来说真的很有帮助，爱你们哦！
有什么问题可以发issue告知我哦，我会立马去修复以及改进的，如果人多的话会考虑去建个微信群的
后续还有很多想发展以及改进的方向，其实该项目是源于我想去复刻一下comfyui的那种workflow，但是做着做着总觉得这缺那缺，还是需要多花点时间去完善
