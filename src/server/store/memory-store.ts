...
const stmts = {
  upsertRun: db.prepare(`
    INSERT INTO run_snapshot(run_id,status,run_mode,run_type,name,root_task_id,workflow_id,workflow_version_id,created_at,started_at,finished_at,output,error)
    VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)
